...
Ten pierwszy odpowiada za d³ugoœæ skoku miêdzy kolejnymi iteracjami. Jeœli jest wiêc za wysoki, skoki równie¿ s¹ zbyt du¿e, wobec czego mo¿e dojœæ do rozbie¿noœci algorytmu, wskutek czego minimum nie zostaje znalezione - algorytm zwraca liczby o coraz wiêkszym module, a¿ przekroczy zakres zmiennej typu float.
